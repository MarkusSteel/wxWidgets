...
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_AUI, wxEVT_AUINOTEBOOK_TAB_LEFT_DCLICK, wxAuiNotebookEvent);
...
wxDECLARE_EXPORTED_EVENT(WXDLLIMPEXP_AUI, wxEVT_AUINOTEBOOK_TAB_RIGHT_CLICK, wxAuiNotebookEvent);
...
#define EVT_AUINOTEBOOK_TAB_LEFT_DCLICK(winid, fn) \
    wx__DECLARE_EVT1(wxEVT_AUINOTEBOOK_TAB_LEFT_DCLICK, winid, wxAuiNotebookEventHandler(fn))
...
#define EVT_AUINOTEBOOK_TAB_RIGHT_CLICK(winid, fn) \
    wx__DECLARE_EVT1(wxEVT_AUINOTEBOOK_TAB_RIGHT_CLICK, winid, wxAuiNotebookEventHandler(fn))
...
%constant wxEventType wxEVT_AUINOTEBOOK_TAB_LEFT_DCLICK;
...
%constant wxEventType wxEVT_AUINOTEBOOK_TAB_RIGHT_CLICK;
...
%pythoncode {
    ...
    EVT_AUINOTEBOOK_TAB_LEFT_DCLICK = wx.PyEventBinder( wxEVT_AUINOTEBOOK_TAB_LEFT_DCLICK, 1 )
    ...
    EVT_AUINOTEBOOK_TAB_RIGHT_CLICK = wx.PyEventBinder( wxEVT_AUINOTEBOOK_TAB_RIGHT_CLICK, 1 )
...
#define wxEVT_COMMAND_AUINOTEBOOK_TAB_LEFT_DCLICK   wxEVT_AUINOTEBOOK_TAB_LEFT_DCLICK
...
#define wxEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_CLICK   wxEVT_AUINOTEBOOK_TAB_RIGHT_CLICK
